...
export default function TheLab() {
  ...
  return (
    <SectionWrapper
      ...
      number="07"
      title="The Model Lab"
      subtitle="The silent alternative: watch a toy model reason without narrating — and see where more computation stops helping. This is the machine-side comparison to your own session."
    >
      <div className="mb-6">
        <SourceBadge
          source={{
