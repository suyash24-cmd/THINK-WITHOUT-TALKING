...
export const metadata: Metadata = {
  title: "Think Without Talking — Does AI Make Us Think Less?",
  description:
    "An interactive research platform. Solve reasoning problems with and without AI assistance, measure the difference in your accuracy, speed, and confidence — then explore what the science says about human and machine reasoning.",
  keywords: [
    "AI assistance",
    "human reasoning",
  ...
  openGraph: {
    title: "Think Without Talking — Does AI Make Us Think Less?",
    description:
      "A live self-experiment in human reasoning: solve problems with and without AI help, then read what changes.",
    type: "website",
  },
};
