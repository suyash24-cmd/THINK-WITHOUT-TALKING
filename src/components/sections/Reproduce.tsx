...
const steps = [
  ...
  },
  {
    ...
    command: "python train.py --task parity \\\n  --state-dim 64 --epochs 200",
  },
  {
    number: "4",
    title: "Evaluate the budget sweep",
    command: "python sweep.py --steps 1,2,3,5,8,12,20,30 \\\n  --output results/accuracy_by_steps.json",
  },
  {
    number: "5",
    title: "Export results for the frontend",
    command: "python export.py --output ../apps/web/src/data/results.json",
  },
];
